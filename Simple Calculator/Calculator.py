...
def user_inputs(number):
    global numberInputs
    global backgroundInput
    numberInputs = str(numberInputs) + str(number)
    if number == "x":
        backgroundValue = str(backgroundInput) + "*"
    elif number == "÷":
        backgroundValue = str(backgroundInput) + "/"
    else:
        backgroundValue = str(backgroundInput) + str(number) 
    user_input.delete(0,tk.END)
    user_input.insert(0, str(numberInputs))
    backgroundInput = backgroundValue
    return

def delete():
    global numberInputs
    global backgroundInput
    numberInputs = str(numberInputs[: -1])
    backgroundInput = str(backgroundInput[: -1])
    user_input.delete(0,tk.END)
    user_input.insert(0, str(numberInputs))
    return
...
def calculate():
    ...
    global backgroundInput
    print(numberInputs)
    print(backgroundInput)
    try:
        answer = eval(backgroundInput)
        user_input.delete(0, tk.END)
        user_input.insert(0, answer)
        numberInputs = str(answer)
        backgroundInput = str(answer)
    except:
        user_input.delete(0, tk.END)
        user_input.insert(0, "Invalid Input")
...
user_input = tk.Entry(root, font=("Arial", 40), bd=10)
user_input.pack()
...
button1 = tk.Button(button_frame, text="1", font=("Arial", 20), command=lambda:user_inputs(1)).grid(column=0, row=0, sticky=tk.W+tk.E)
button2 = tk.Button(button_frame, text="2", font=("Arial", 20), command=lambda:user_inputs(2)).grid(column=1, row=0, sticky=tk.W+tk.E)
button3 = tk.Button(button_frame, text="3", font=("Arial", 20), command=lambda:user_inputs(3)).grid(column=2, row=0, sticky=tk.W+tk.E)
button4 = tk.Button(button_frame, text="4", font=("Arial", 20), command=lambda:user_inputs(4)).grid(column=0, row=1, sticky=tk.W+tk.E)
button5 = tk.Button(button_frame, text="5", font=("Arial", 20), command=lambda:user_inputs(5)).grid(column=1, row=1, sticky=tk.W+tk.E)
button6 = tk.Button(button_frame, text="6", font=("Arial", 20), command=lambda:user_inputs(6)).grid(column=2, row=1, sticky=tk.W+tk.E)
button7 = tk.Button(button_frame, text="7", font=("Arial", 20), command=lambda:user_inputs(7)).grid(column=0, row=2, sticky=tk.W+tk.E)
button8 = tk.Button(button_frame, text="8", font=("Arial", 20), command=lambda:user_inputs(8)).grid(column=1, row=2, sticky=tk.W+tk.E)
button9 = tk.Button(button_frame, text="9", font=("Arial", 20), command=lambda:user_inputs(9)).grid(column=2, row=2, sticky=tk.W+tk.E)
buttonC = tk.Button(button_frame, text="C", font=("Arial", 20), command=lambda:delete_all()).grid(column=0, row=3, sticky=tk.W+tk.E)
button0 = tk.Button(button_frame, text="0", font=("Arial", 20), command=lambda:user_inputs(0)).grid(column=1, row=3, sticky=tk.W+tk.E)
buttonEqual = tk.Button(button_frame, text="=", font=("Arial", 20), command=lambda:calculate()).grid(column=2, row=3, sticky=tk.W+tk.E)
buttonAddition = tk.Button(button_frame, text="+", font=("Arial", 20), command=lambda:user_inputs("+")).grid(column=0, row=4, sticky=tk.W+tk.E)
buttonSubtraction = tk.Button(button_frame, text="-", font=("Arial", 20), command=lambda:user_inputs("-")).grid(column=1, row=4, sticky=tk.W+tk.E)
buttonMultiplication = tk.Button(button_frame, text="x", font=("Arial", 20), command=lambda:user_inputs("x")).grid(column=2, row=4, sticky=tk.W+tk.E)
buttonDivision = tk.Button(button_frame, text="÷", font=("Arial", 20), command=lambda:user_inputs("÷")).grid(column=1, row=5, sticky=tk.W+tk.E)
buttonDelete = tk.Button(button_frame, text="<", font=("Arial", 20), command=lambda:delete()).grid(column=2, row=5, sticky=tk.W+tk.E)
button_frame.pack(fill="x")
root.mainloop()
"""